...
public abstract class Aplicant {
    ...
    public void statutAplicant() {
        System.out.println("Aplicantul " + this.nume + " " + this.prenume + (this.punctaj > Aplicant.pragAcceptare ? " " : "nu") + "a fost acceptat");
    }
    public abstract void afisareFinantare();

    protected void afisareFinantare(int sumaFinantare, String tipPersoana) {
        System.out.println(tipPersoana + " " + getNume() + " " + getPrenume() + " primeste" + sumaFinantare + " Euro/zi in proiect.");
    }
